...
public final class OpenWeatherJsonUtils {
    ...
    public static ContentValues[] getWeatherContentValuesFromJson(Context context, String forecastJsonStr)
        ...
        Log.v("json",cityLatitude+" "+cityLongitude);
...
//        long normalizedUtcStartDay = SunshineDateUtils.normalizeDate(now);
    ...
    public static void MyJson1getWeatherContentValuesFromJson(Context context, String forecastJsonStr)
            throws JSONException {
        ...
        JSONObject cityCoord = forecastJson.getJSONObject("coord");
        double cityLatitude = cityCoord.getDouble(OWM_LATITUDE);
        double cityLongitude = cityCoord.getDouble(OWM_LONGITUDE);
    ...
    public static ContentValues[] MyJson2getWeatherContentValuesFromJson(Context context, String forecastJsonStr)
            throws JSONException {
        ...
        JSONArray jsonWeatherArray = forecastJson.getJSONArray("daily");
...
//        long normalizedUtcStartDay = SunshineDateUtils.normalizeDate(now);
        ...
        long normalizedUtcStartDay = SunshineDateUtils.getNormalizedUtcDateForToday();
        Log.v("my",jsonWeatherArray.length()+"");
        for (int i = 0; i < jsonWeatherArray.length(); i++) {
            ...
            windDirection = dayForecast.getDouble("wind_deg");
            ...
            JSONArray array = dayForecast.getJSONArray("weather");
            Log.v("my",array.length()+"");
