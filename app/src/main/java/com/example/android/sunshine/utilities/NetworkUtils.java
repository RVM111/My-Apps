...
public final class NetworkUtils {
    ...
    private static final String GET_COORDINATES_URL ="https://api.openweathermap.org/data/2.5/weather";

    private static final String GET_7_DAYS_WEATHER_DATA_URL = "https://api.openweathermap.org/data/2.5/onecall";
    ...
    public static URL MybuildUrlWithLatitudeLongitude(Double latitude, Double longitude) {
        Uri weatherQueryUri = Uri.parse(GET_7_DAYS_WEATHER_DATA_URL).buildUpon()
                .appendQueryParameter(LAT_PARAM, String.valueOf(latitude))
                .appendQueryParameter(LON_PARAM, String.valueOf(longitude))
                .appendQueryParameter("exclude","hourly,minutely")
                .appendQueryParameter(UNITS_PARAM,"metric")
                .appendQueryParameter("appid","19ddaf9b43bd51a4310ae07b6e6390d5")
                .build();
    ...
    public static URL MybuildUrlWithLocationQuery(String locationQuery) {
        Uri weatherQueryUri = Uri.parse(GET_COORDINATES_URL).buildUpon()
                .appendQueryParameter(QUERY_PARAM, locationQuery)
                .appendQueryParameter("appid","19ddaf9b43bd51a4310ae07b6e6390d5")
                .build();
